      ...
      <div className="container px-5 py-10 mx-auto lg:px-20">
        ...
        <div className="flex flex-col sm:items-center items-start">
          {experiences.map((experience, index) => (
            <div className="show-on-scroll animate-stop animate-fade-up animate-once animate-ease-out animate-delay-200 p-4 md:w-3/5 w-full">
              <div className="h-full bg-lighter-pink p-6 rounded-2xl">
                <div className="flex flex-row items-center pb-8">
                  ...
                  <div className="flex flex-col items-start pl-2">
                    ...
                    <p className="text-md font-poppins text-darker-pink text-left">
                      {experience.role}
                    </p>
                  </div>
                  <p className="text-md text-right font-poppins font-bold text-darker-pink ml-auto self-start pt-1">
                    {experience.duration}
                  </p>
                </div>
                    ...
                    <ul className="list-none">
                      {desc.d1 ? 
                        <li className="flex flex-row pb-3">
                          <svg className="fill-darker-pink flex-shrink-0" viewBox="0 0 24 24" focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                            <path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path>
                          </svg>
                          <p className="text-md font-poppins text-darker-pink text-justify">{desc.d1}</p>
                        </li> : null}
                      {desc.d2 ? 
                        <li className="flex flex-row pb-3">
                          <svg className="fill-darker-pink flex-shrink-0" viewBox="0 0 24 24" focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                          ...
                          <p className="text-md font-poppins text-darker-pink text-justify">{desc.d2}</p>
                        </li> : null}
                      {desc.d3 ? 
                        <li className="flex flex-row pb-3">
                          <svg className="fill-darker-pink flex-shrink-0" viewBox="0 0 24 24" focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                          ...
                          <p className="text-md font-poppins text-darker-pink text-justify">{desc.d3}</p>
                        </li> : null}
                    </ul>
                  </div>
                ))}
                ...
                <div className="flex flex-row flex-wrap items-start pt-3">
                  {experience.skills.map(skill => ( 
                      <p className="font-poppins font-bold text-lighter-pink sm:text-md text-sm bg-dark-pink px-2 py-1 rounded-lg mt-2 mr-2">
                        {skill}</p>  
                  ))}
                </div>
              </div>
